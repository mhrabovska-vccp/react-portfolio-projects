  ...
  return (
    <div className='text-black'>
        <div className='max-w-[1000px] mt-[100px] mb-[50px] w-full mx-auto text-center flex flex-col justify-center'>
            ...
            <div>
                <p className='md:text-3xl sm:text-2xl text-xl font-bold'>JSX, React Components, Props, Lists, React Hooks, State, Routing, Forms, Fetch API, Styled-Components, Material UI, Tailwind CSS  </p>
            </div>
        </div>
    </div>
  )
